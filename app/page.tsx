...
const ShoppingApp = () => {
  ...
  const [reviews, setReviews] = useState<Review[]>([
    {
      ...
      userName: "Alex M.",
      rating: 5,
      comment: "Perfect fit and amazing quality! The fabric feels premium and the design is exactly what I was looking for.",
      date: "2024-01-15",
      helpful: 12
    },
    {
      ...
      userName: "Sarah K.",
      rating: 4,
      comment: "Great product overall. The sizing runs a bit large, so consider ordering one size down.",
      date: "2024-01-10",
      helpful: 8
    },
    {
      ...
      userName: "Mike R.",
      rating: 5,
      comment: "Exceeded my expectations. The minimalist design is perfect for everyday wear.",
      date: "2024-01-08",
      helpful: 15
    }
  ]);
  ...
  const handleReviewSubmit = (e: React.FormEvent) => {
    ...
    if (newReview.comment.trim()) {
      ...
      // Update the selected product's rating
      if (selectedProduct) {
        ...
        // Also update the product in the main products array and filtered products
        const updateProductsArray = (productsArray: Product[]) => 
          productsArray.map(product => 
            product.id === selectedProduct.id ? updatedProduct : product
          );
        
        setFilteredProducts(updateProductsArray);
        setProducts(updateProductsArray);
        
        // Update the main products state so rating persists across navigation
      }
  ...
  const toggleHelpfulReview = (reviewId: number) => {
    const isCurrentlyHelpful = helpfulReviews.includes(reviewId);
    
    if (isCurrentlyHelpful) {
      // Remove from helpful and decrease count
      ...
      // Add to helpful and increase count
    ...
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-slate-900 text-white' : 'bg-slate-50 text-slate-900'}`}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute top-0 right-0 w-[600px] h-[600px] rounded-full filter blur-3xl opacity-20 ${
          isDarkMode ? 'bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600' : 'bg-gradient-to-br from-emerald-200 via-teal-200 to-cyan-200'
        }`}></div>
        <div className={`absolute bottom-0 left-0 w-[500px] h-[500px] rounded-full filter blur-3xl opacity-20 ${
          isDarkMode ? 'bg-gradient-to-tr from-cyan-600 via-blue-600 to-emerald-600' : 'bg-gradient-to-tr from-cyan-200 via-blue-200 to-emerald-200'
        }`}></div>
        <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full filter blur-3xl opacity-10 ${
          isDarkMode ? 'bg-gradient-to-r from-teal-600 via-emerald-600 to-cyan-600' : 'bg-gradient-to-r from-teal-200 via-emerald-200 to-cyan-200'
        }`}></div>
      ...
      <nav className={`fixed w-full backdrop-blur-xl z-50 border-b transition-all duration-300 ${
        isDarkMode 
          ...
          : 'bg-white/90 border-slate-200/50 shadow-lg shadow-slate-900/10'
      }`}>
              ...
              <div className="hidden lg:flex items-center">
                <div className={`relative ${isDarkMode ? 'text-slate-300' : 'text-slate-600'}`}>
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 rounded-full border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                      isDarkMode 
      ...
      <main className="pt-16 md:pt-24">
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden">
            {/* Main gradient blobs */}
            <div className={`absolute top-20 right-20 w-[400px] h-[400px] rounded-full filter blur-3xl opacity-30 animate-pulse ${
              isDarkMode ? 'bg-gradient-to-br from-emerald-500 via-cyan-500 to-teal-500' : 'bg-gradient-to-br from-emerald-200 via-cyan-200 to-teal-200'
            }`} style={{ animationDuration: '4s' }}></div>
            <div className={`absolute bottom-20 left-20 w-[350px] h-[350px] rounded-full filter blur-3xl opacity-25 animate-pulse ${
              isDarkMode ? 'bg-gradient-to-tr from-violet-500 via-purple-500 to-pink-500' : 'bg-gradient-to-tr from-violet-200 via-purple-200 to-pink-200'
            }`} style={{ animationDuration: '6s', animationDelay: '1s' }}></div>
            <div className={`absolute top-1/3 left-1/3 w-[300px] h-[300px] rounded-full filter blur-3xl opacity-20 animate-pulse ${
              isDarkMode ? 'bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500' : 'bg-gradient-to-r from-blue-200 via-indigo-200 to-purple-200'
            }`} style={{ animationDuration: '8s', animationDelay: '2s' }}></div>
            
            {/* Floating geometric shapes */}
            <div className={`absolute top-1/4 right-1/3 w-32 h-32 rounded-2xl rotate-45 opacity-10 ${
              isDarkMode ? 'bg-gradient-to-br from-cyan-400 to-emerald-400' : 'bg-gradient-to-br from-cyan-300 to-emerald-300'
            }`}></div>
            <div className={`absolute bottom-1/3 right-1/4 w-24 h-24 rounded-full opacity-15 ${
              isDarkMode ? 'bg-gradient-to-r from-pink-400 to-purple-400' : 'bg-gradient-to-r from-pink-300 to-purple-300'
            }`}></div>
            
            {/* Subtle pattern overlay */}
            <div className={`absolute inset-0 pattern-dots opacity-20 ${isDarkMode ? 'opacity-10' : 'opacity-30'}`}></div>
          </div>
          
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 md:py-32 flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
            ...
            >
              ...
              >
                <div className="relative group">
                  ...
                  <div className={`absolute -top-8 -left-8 w-32 h-32 rounded-full filter blur-2xl opacity-70 group-hover:opacity-90 transition-opacity duration-500 ${
                    isDarkMode ? 'bg-gradient-to-br from-emerald-400 to-cyan-400' : 'bg-gradient-to-br from-emerald-300 to-cyan-300'
                  }`}></div>
                  <div className={`absolute -bottom-8 -right-8 w-40 h-40 rounded-full filter blur-2xl opacity-60 group-hover:opacity-80 transition-opacity duration-500 ${
                    isDarkMode ? 'bg-gradient-to-br from-purple-400 to-pink-400' : 'bg-gradient-to-br from-purple-300 to-pink-300'
                  }`}></div>
                  <div className={`absolute top-1/4 -right-4 w-20 h-20 rounded-full filter blur-xl opacity-50 group-hover:opacity-70 transition-opacity duration-500 ${
                    isDarkMode ? 'bg-gradient-to-br from-yellow-400 to-orange-400' : 'bg-gradient-to-br from-yellow-300 to-orange-300'
                  }`}></div>
                  
                  {/* Main image with improved styling */}
                  <div className={`relative rounded-3xl overflow-hidden ${
                    isDarkMode ? 'shadow-2xl shadow-slate-900/60' : 'shadow-2xl shadow-slate-900/25'
                  }`}>
                    <img 
                      src="https://i.ibb.co/1tg7V22y/photo-1515886657613-9f3515b0c78f.jpg" 
                      alt="Minimalist fashion model" 
                      className="max-h-[650px] md:max-h-[700px] w-auto mx-auto relative z-10 transition-transform duration-500 group-hover:scale-105"
                    />
                    {/* Overlay gradient */}
            ...
            >
              ...
              <motion.div
                ...
                className="mb-6"
              >
                <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium backdrop-blur-md ${
                  isDarkMode 
                    ? 'bg-slate-800/80 text-emerald-300 border border-slate-700/50' 
                    : 'bg-white/80 text-emerald-600 border border-slate-200/50'
                }`}>
              ...
              >
                <motion.h1 
                  className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-heading mb-6 leading-[0.9] tracking-tight ${
                    isDarkMode ? 'text-white' : 'text-slate-900'
                  }`}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <span className="relative">
                    <span className="text-gradient bg-gradient-to-r from-emerald-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent">
                      Fashion
                    </span>
                    {/* Underline decoration */}
                    <div className={`absolute -bottom-2 left-0 w-full h-1 rounded-full bg-gradient-to-r from-emerald-400 via-cyan-400 to-teal-400 opacity-60`}></div>
                  </span>
                </motion.h1>
                
                <motion.p 
                  className={`text-lg md:text-xl mb-8 leading-relaxed max-w-lg font-light ${
                    isDarkMode ? 'text-slate-300' : 'text-slate-600'
                  } ${!isDarkMode ? 'lg:max-w-2xl' : ''}`}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, delay: 0.9 }}
                >
                  Curated collections that embody simplicity, quality, and timeless design for the modern wardrobe. 
                  Experience fashion that speaks to your soul.
                </motion.p>
                ...
                >
                  {[
                    { number: '500+', label: 'Premium Items' },
              ...
              >
                <motion.button
                  ...
                  className={`px-8 py-4 font-semibold rounded-full transition-all duration-300 backdrop-blur-md transform hover:scale-105 shadow-lg ${
                    isDarkMode 
                      ? 'bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-white shadow-emerald-500/25' 
                      : 'bg-gradient-to-r from-slate-900 to-slate-800 hover:from-slate-800 hover:to-slate-700 text-white shadow-slate-900/25'
                  }`}
                >
                  <span className="flex items-center justify-center gap-2 text-center cursor-pointer">
                    Explore Collection
                ...
                <motion.button
                  ...
                  className={`px-8 py-4 font-semibold rounded-full transition-all cursor-pointer duration-300 backdrop-blur-md transform hover:scale-105 ${
                    isDarkMode 
                      ? 'border-2 border-slate-600 hover:border-slate-500 text-slate-300 hover:bg-slate-800/50' 
                      : 'border-2 border-slate-300 hover:border-slate-400 text-slate-900 hover:bg-slate-50/50'
                  }`}
                >
                  Learn More
                </motion.button>
            ...
            >
              <motion.div 
                ...
                >
                     ...
                     isDarkMode ? 'text-white/70' : 'text-slate-600/80'
        ...
        {currentPage === 'product' && selectedProduct && (
          <motion.section
            ...
            exit="hidden"
            variants={pageTransition}
            className={`min-h-screen pt-12 pb-20 transition-colors duration-300 ${
              ...
              <motion.div variants={containerVariants} className="space-y-12">
                    ...
                    <div className="relative aspect-square overflow-hidden rounded-3xl">
                      ...
                      <div className="absolute top-6 right-6 z-10">
                        <motion.button
                          whileHover={{ scale: 1.1 }}
                          whileTap={{ scale: 0.9 }}
                          className={`p-4 rounded-full backdrop-blur-md transition-all duration-200 shadow-lg cursor-pointer ${
                        ...
                        >
                          <svg className="w-6 h-6" fill={favoriteItems.includes(selectedProduct.id) ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                          </svg>
                        </motion.button>
                      </div>
                  ...
                  <motion.div variants={itemVariants} className="space-y-8">
                      ...
                      <div className="flex items-center gap-4">
                        <div className={`flex items-center rounded-xl ${
                          ...
                          <motion.button
                            ...
                            className={`p-4 rounded-l-xl transition-colors cursor-pointer ${
                              isDarkMode 
                          ...
                          <span className={`px-8 py-4 font-semibold min-w-[80px] text-center ${
                            isDarkMode ? 'text-white' : 'text-gray-900'
                          }`}>{quantity}</span>
                          <motion.button
                            whileHover={{ scale: 1.1 }}
                            ...
                            className={`p-4 rounded-r-xl transition-colors cursor-pointer ${
                              isDarkMode 
                                ? 'text-gray-300 hover:bg-gray-600' 
                                : 'text-gray-700 hover:bg-gray-200'
                            }`}
                    ...
                    <div className="flex gap-4">
                      <motion.button
                        ...
                        className={`flex-1 px-8 py-4 font-semibold text-lg rounded-2xl transition-all duration-200 ${
                          selectedSize 
                            ? (isDarkMode 
                ...
                <motion.div variants={itemVariants} className={`border-t pt-12 ${
                  ...
                  <div className="max-w-4xl mx-auto">
                    ...
                    {/* Review Stats */}
                    <div className={`bg-gradient-to-r rounded-2xl p-6 mb-8 ${
                      isDarkMode 
                        ? 'from-gray-800 to-gray-700 border border-gray-600' 
                      ...
                      <div className="grid md:grid-cols-2 gap-8 items-center">
                        <div className="text-center md:text-left">
                          ...
                          <p className={`text-sm ${
                            ...
                            Based on {selectedProduct.reviews} reviews
                          </p>
                        </div>
                        <div className="text-center md:text-right">
                          <p className={`text-2xl font-bold mb-1 ${
                            ...
                            {Math.round((reviews.length / (selectedProduct.reviews || 1)) * 100)}%
                          </p>
                          <p className={`text-sm ${
                            isDarkMode ? 'text-gray-400' : 'text-gray-600'
                          }`}>
                      ...
                      <form onSubmit={handleReviewSubmit} className="space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className={`w-full px-4 py-3 rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none ${
                              isDarkMode 
                                ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400' 
                                : 'bg-white border-gray-300 text-gray-900 placeholder-gray-500'
                            }`}
                        ...
                        <motion.button
                          ...
                          whileHover="hover"
                          whileTap="tap"
                          className={`px-6 py-3 font-semibold rounded-xl transition-all duration-200 cursor-pointer ${
                            isDarkMode 
                          ...
                          <p className={`mb-4 leading-relaxed ${
                            ...
                            {review.comment}
                             ...
                             <motion.button
                               whileHover={{ scale: 1.05 }}
                               whileTap={{ scale: 0.95 }}
                               onClick={() => toggleHelpfulReview(review.id)}
                               className={`flex items-center gap-2 text-sm px-3 py-2 rounded-lg transition-all duration-200 cursor-pointer ${
                             ...
                             >
                               <svg 
                                 className="w-4 h-4" 
                                 fill={helpfulReviews.includes(review.id) ? "currentColor" : "none"} 
                                 stroke="currentColor" 
                                 viewBox="0 0 24 24"
                               >
                                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5" />
                               </svg>
                               {helpfulReviews.includes(review.id) ? 'Helpful' : 'Helpful'} ({review.helpful})
                             </motion.button>
                           </div>
                        </motion.div>
                      ))}
